...
import { LayoutDashboard, Package, Sliders, BookOpen, UserCheck, BarChart3, ExternalLink, Sparkles, Shield, Coins } from "lucide-react";

const NAV_ITEMS = [
  { label: "Overview", href: "/admin", icon: LayoutDashboard },
  { label: "Sales CRM & Leads", href: "/admin/crm", icon: UserCheck },
  { label: "Products & Categories", href: "/admin/products", icon: Package },
  { label: "Funnel Analytics", href: "/admin/analytics", icon: BarChart3 },
  { label: "AI Costs & Credits", href: "/admin/costs", icon: Coins },
  { label: "AI Configuration", href: "/admin/settings", icon: Sliders },
  { label: "Prompt Library", href: "/admin/prompts", icon: BookOpen },
];
    ...
    <aside className="w-64 bg-white/[0.02] border-r border-white/10 flex flex-col justify-between p-6 shrink-0 min-h-screen">
      ...
      <div className="pt-6 border-t border-white/10 flex flex-col gap-3">
        <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 border border-white/5">
          ...
          <span className="text-xs text-white/60 font-medium">Super Admin Active</span>
        </div>
        <Link
          href="/"
