    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <Link
          ...
          className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-amber-400 via-orange-400 to-rose-500 text-white font-bold text-xs shadow-lg shadow-orange-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
        >
      ...
      {/* Filter Toolbar */}
      <div className="rounded-2xl bg-white/[0.03] border border-white/8 p-4 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
        <div className="flex flex-wrap items-center gap-3 flex-1">
          ...
          <div className="relative min-w-[240px]">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 rounded-xl bg-white/5 border border-white/10 text-white text-xs placeholder:text-white/20 focus:outline-none focus:border-amber-400/50"
            />
          </div>
        ...
        {selectedIds.length > 0 && (
          <div className="flex items-center gap-2 animate-fade-in bg-amber-400/10 border border-amber-400/30 px-3 py-1.5 rounded-xl">
            <span className="text-xs font-bold text-amber-300 mr-1">{selectedIds.length} Selected:</span>
            <button
              onClick={() => handleBulkAction("publish")}
              disabled={processing}
              className="px-2.5 py-1 rounded-lg bg-emerald-500/20 text-emerald-300 text-xs font-semibold hover:bg-emerald-500/30"
            >
              Publish
            </button>
            <button
              ...
              disabled={processing}
              className="px-2.5 py-1 rounded-lg bg-white/10 text-white/70 text-xs font-semibold hover:bg-white/20"
            >
              Archive
            </button>
            <button
              ...
              disabled={processing}
              className="px-2.5 py-1 rounded-lg bg-red-500/20 text-red-300 text-xs font-semibold hover:bg-red-500/30"
            >
              Delete
            </button>
          </div>
      ...
      {loading ? (
        ...
        <div className="rounded-2xl bg-white/[0.02] border border-white/5 p-16 text-center flex flex-col items-center gap-3">
