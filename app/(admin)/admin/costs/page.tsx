  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-white/8">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-tight">AI Credits &amp; Costs</h1>
        ...
        <div className="flex items-center gap-3 shrink-0">
          <a
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-white text-xs font-semibold transition-all"
          >
            <Download className="w-3.5 h-3.5" /> Export Try-Ons (CSV)
          </a>
          <a
            href="/api/admin/costs/export?type=credits"
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-amber-400 to-rose-500 hover:scale-[1.02] active:scale-[0.98] text-white text-xs font-bold transition-all shadow-lg shadow-orange-500/10"
          >
            <Download className="w-3.5 h-3.5" /> Export Credits Ledger (CSV)
          </a>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="rounded-2xl bg-white/[0.03] border border-white/8 p-6 flex flex-col justify-between overflow-hidden group hover:border-white/20 transition-all">
          <div className="flex items-center justify-between mb-4">
            <span className="text-xs font-semibold text-white/50 uppercase tracking-wider">Estimated AI Spend</span>
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-rose-400 to-pink-500 flex items-center justify-center text-black shadow-md">
        ...
        <div className="rounded-2xl bg-white/[0.03] border border-white/8 p-6 flex flex-col justify-between overflow-hidden group hover:border-white/20 transition-all">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center text-black shadow-md">
        ...
        <div className="rounded-2xl bg-white/[0.03] border border-white/8 p-6 flex flex-col justify-between overflow-hidden group hover:border-white/20 transition-all">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center text-black shadow-md">
